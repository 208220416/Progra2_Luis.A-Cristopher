...
public class MainExercise2 {
    ...
    public static void main(String[] args) {
        ...
        employeesList.addEmployee(new Employee(20876442, "Raul", "Jose", "Arias", "Zamora", 50000));
        employeesList.addEmployee(new Employee(20876442, "Jose", "Luis", "Quesada", "Rojas", 10000));
        employeesList.addEmployee(new Employee(20876442, "Luis", "Armando", "Soto", "Monge", 20000));
        employeesList.addEmployee(new Employee(20876442, "Armando", "Julian", "Rodriguez", "Cubero", 30000));
